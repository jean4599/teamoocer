	...
	var ComfirmLinkPhrase = _react2.default.createClass({
		...
		getInitialState: function getInitialState() {
			return {
				...
				edge: this.getEdgeData(this.props.data.edge)
			};
		},
		...
		getEdgeData: function getEdgeData(edgeID) {
			...
			console.log(edgeID);
			_firebase2.default.database().ref(this.props.courseID + '/_network/_edges/' + edgeID).once('value').then(function (snapshot) {
