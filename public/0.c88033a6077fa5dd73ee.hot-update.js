	...
	var BubbleChart = function (_React$Component) {
	  ...
	  _createClass(BubbleChart, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(_reactBubbleChart2.default, null, 'className="my-cool-chart" colorLegend=', colorLegend, 'data=', data, 'selectedColor="#737373" selectedTextColor="#d9d9d9" fixedDomain=', { min: -1, max: 1 }, 'legend=', true, 'legendSpacing=', 0, 'tooltip=', true, 'tooltipProps=', tooltipProps);
	    }
	  }]);
