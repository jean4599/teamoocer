...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement('div', null, _react2.default.createElement(Element, { name: 'test2', className: 'element' }, _react2.default.createElement('div', { style: { padding: 50, backgroundColor: '#e9e9e9', minHeight: '100%' } }, _react2.default.createElement(_ConceptExtraction2.default, { courseURL: this.state.courseURL, courseID: this.state.courseID }))), _react2.default.createElement(Link, { activeClass: 'active', to: 'test1', spy: true, smooth: true, offset: 50, duration: 500 }, _react2.default.createElement(_row2.default, { style: { backgroundColor: '#e9e9e9' } }, _react2.default.createElement(_col2.default, { className: 'half-circle-up center' }, 'Go discussion'))), _react2.default.createElement(Element, { name: 'test1', className: 'element' }, _react2.default.createElement(Link, { activeClass: 'active', to: 'test2', spy: true, smooth: true, offset: 50, duration: 500 }, _react2.default.createElement(_row2.default, { className: 'half-circle-down' }, _react2.default.createElement(_col2.default, { className: 'center' }, 'Go discussion'))), _react2.default.createElement('div', { style: { padding: 50, backgroundColor: 'white', minHeight: '80%' } }, _react2.default.createElement(_ConceptMapping2.default, { courseURL: this.state.courseURL, courseID: this.state.courseID }))));
		}
	});
