...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConceptMapping = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement('div', null, _.requests.map(function (request, index) {
				return _react2.default.createElement('div', { style: { left: request.x, top: request.y } }, request.content);
			}), _react2.default.createElement(_row2.default, { type: 'flex', justify: 'space-around', align: 'middle' }, _react2.default.createElement(_col2.default, { span: 2 }, _react2.default.createElement(_button2.default, { onClick: function onClick() {
