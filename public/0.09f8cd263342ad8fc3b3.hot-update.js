...
/***/ function(module, exports, __webpack_require__) {
	...
	var _style6 = __webpack_require__(605);
	...
	var Main = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement('div', null, _react2.default.createElement('div', { style: { padding: 50, backgroundColor: '#e9e9e9', minHeight: '80%' } }, _react2.default.createElement(_ConceptExtraction2.default, { courseURL: this.state.courseURL, courseID: this.state.courseID })), _react2.default.createElement(Link, { href: 'Discussion' }, ' ', _react2.default.createElement(_row2.default, { style: { backgroundColor: '#e9e9e9' } }, _react2.default.createElement(_col2.default, { className: 'half-circle-up center' }, 'Go discussion')), ' '), _react2.default.createElement(_row2.default, { className: 'half-circle-down' }, _react2.default.createElement(_col2.default, { className: 'center' }, 'Go discussion')), _react2.default.createElement('div', { href: 'Discussion', style: { padding: 50, backgroundColor: 'white', minHeight: '80%' } }, _react2.default.createElement(_ConceptMapping2.default, { courseURL: this.state.courseURL, courseID: this.state.courseID })));
		}
	});
