...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConceptExtraction = _react2.default.createClass({
		...
		render: function render() {
			console.log(this.props.route.courseURL);
			return _react2.default.createElement(_row2.default, null, _react2.default.createElement(_col2.default, { span: 16 }, _react2.default.createElement(_VideoPlayer2.default, { courseURL: this.props.route.courseURL, ref: 'player' })), _react2.default.createElement(_col2.default, { span: 8 }, _react2.default.createElement(_InputConcept2.default, { courseURL: this.props.route.courseURL, getPlayedTime: this.getPlayedTime, jumpToTime: this.jumpToTime })));
		}
	});
