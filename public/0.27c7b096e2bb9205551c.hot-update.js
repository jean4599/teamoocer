...
/***/ function(module, exports, __webpack_require__) {
	...
	var VideoPlayer = _react2.default.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    return {
	      courseURL: "https://www.youtube.com/watch?v=p4XTMvagQ2Q",
	      playing: true,
	      volume: 0.8,
	      played: 0,
	      loaded: 0,
	  ...
	  stop: function stop() {
	    this.setState({ courseURL: null, playing: false });
	  },
	  ...
	  renderLoadButton: function renderLoadButton(courseURL, label) {
	    var _this = this;

	    return _react2.default.createElement('button', { onClick: function onClick() {
	        return _this.load(courseURL);
	      } }, label);
	  },
