...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConceptMapping = _react2.default.createClass({
		...
		updateConcept: function updateConcept(snapshot) {
			var nodes = (0, _utils.retrieveData)(snapshot.val(), 'key', 'word');
			nodes = new _vis2.default.DataSet([{ id: 1, label: 'Node 1' }, { id: 2, label: 'Node 2' }, { id: 3, label: 'Node 3' }, { id: 4, label: 'Node 4' }, { id: 5, label: 'Node 5' }]);
			var edges = new _vis2.default.DataSet([{ from: 1, to: 3 }, { from: 1, to: 2 }, { from: 2, to: 4 }, { from: 2, to: 5 }]);
			var data = {
				nodes: nodes,
				edges: edges
