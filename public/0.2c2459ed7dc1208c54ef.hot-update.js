...
/***/ function(module, exports, __webpack_require__) {
	...
	var _d = __webpack_require__(416);

	var _d2 = _interopRequireDefault(_d);

	var _d3Hierarchy = __webpack_require__(420);
	...
	var pack = _d2.default.layout.pack().size([width, width]).padding(1.5);
	...
	_d2.default.csv("flare.csv", function (d) {
	    ...
	    var root = _d2.default.layout.hierarchy({ children: classes }).sum(function (d) {
	        return d.value;
	    }).each(function (d) {
	        if (id = d.data.id) {
	            var id,
