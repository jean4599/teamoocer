	...
	var ConceptMapping = _react2.default.createClass({
			...
			network.on("selectNode", function (params) {
				...
				switch (_.mode) {
					...
					case "AddEdge_SelectFirstNode":
						...
						_this.setState({ firstNode: word, mode: "AddEdge_SelectSecondNode" });
						_this.SecondNode.focus();
						break;
					case "AddEdge_SelectSecondNode":
						options.nodes.chosen = true;
						_this.setState({ secondNode: word, mode: "Nomal" });
						_this.Finishbtn.focus();
				}
			});
		...
		render: function render() {
			...
			return _react2.default.createElement('div', null, _react2.default.createElement(_row2.default, null, _react2.default.createElement(_col2.default, { span: 8 }, _react2.default.createElement(_button2.default, { onClick: function onClick() {
				...
				} }, 'Add Edge'), _react2.default.createElement(_button2.default, { onClick: function onClick() {
					return _this2.addEdge('finish');
				}, ref: function ref(btn) {
					_this2.Finishbtn = btn;
				} }, 'Finish')), _react2.default.createElement(_col2.default, { span: 8 }, _react2.default.createElement(_input2.default, { ref: function ref(input) {
					_this2.FirstNode = input;
				}, addonBefore: 'From', placeholder: "click the starting node", value: _.firstNode })), _react2.default.createElement(_col2.default, { span: 8 }, _react2.default.createElement(_input2.default, { ref: function ref(input) {
					_this2.SecondNode = input;
				}, addonBefore: 'To', placeholder: "click the ending node", value: _.secondNode }))), _react2.default.createElement('div', { ref: function ref(container) {
