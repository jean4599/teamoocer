...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComfirmLinkPhrase = _react2.default.createClass({
		...
		render: function render() {
			var _ = this.state;
			return _react2.default.createElement(_card2.default, null, _react2.default.createElement('p', { id: 'comfirm-title' }, 'Do you think this is a proper link phrase?'), _react2.default.createElement(_row2.default, { className: 'comfirm-graph container' }, _react2.default.createElement(_col2.default, { span: 6, className: 'comfirm-graph' }, ' ', _react2.default.createElement('p', { className: 'node left' }), ' '), _react2.default.createElement(_col2.default, { span: 12, className: 'comfirm-graph' }, ' ', _react2.default.createElement('p', { className: 'link' }), ' '), _react2.default.createElement(_col2.default, { span: 6, className: 'comfirm-graph' }, ' ', _react2.default.createElement('p', { className: 'node right' }), ' ')), _react2.default.createElement(_row2.default, { className: 'comfirm-graph container' }, _react2.default.createElement(_col2.default, { span: 6, className: 'comfirm-graph' }, _.edge.from), _react2.default.createElement(_col2.default, { span: 12, className: 'comfirm-graph' }, _.edge.label), _react2.default.createElement(_col2.default, { span: 6, className: 'comfirm-graph' }, _.edge.to)));
		}
	});
