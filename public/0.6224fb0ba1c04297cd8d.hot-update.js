...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConceptAggregation = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    })), _react2.default.createElement(_col2.default, null, _react2.default.createElement(_card2.default, { title: 'Level 1', style: { width: 300 }, onClick: this.handleLevelChange(1) }, this.state.level1_concepts), _react2.default.createElement(_card2.default, { title: 'Level 2', style: { width: 300 }, onClick: this.handleLevelChange(2) }, this.state.level2_concepts), _react2.default.createElement(_card2.default, { title: 'Level 3', style: { width: 300 }, onClick: this.handleLevelChange(3) }, this.state.level3_concepts)));
	  }
	});
