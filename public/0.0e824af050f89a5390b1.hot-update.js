	...
	var ConceptAggregation = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(_row2.default, null, _react2.default.createElement(_col2.default, null, this.state.concepts.map(function (concept, index) {
	      return _react2.default.createElement(_tag2.default, { color: _this.tagColor(concept.level), onClick: function onClick() {
	          return _this.handleConceptClicked(concept.key);
	        } }, concept.word);
	    })), _react2.default.createElement(_col2.default, null, _react2.default.createElement(_card2.default, { title: 'Level 1', bordered: true, style: { width: 300 }, onClick: function onClick() {
	        return _this.handleLevelChange(1);
	      } }, this.state.level1_concepts), _react2.default.createElement(_card2.default, { title: 'Level 2', bordered: false, style: { width: 300 }, onClick: function onClick() {
