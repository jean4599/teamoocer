...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement('div', null, _react2.default.createElement(Element, { name: 'video', className: 'element' }, _react2.default.createElement('div', { style: { padding: '10 50', backgroundColor: '#e9e9e9', minHeight: '80%' } }, _react2.default.createElement(_ConceptExtraction2.default, { courseURL: this.state.courseURL, courseID: this.state.courseID }))), _react2.default.createElement(Link, { activeClass: 'active', to: 'discussion', spy: true, smooth: true, offset: 50, duration: 500 }, _react2.default.createElement(_row2.default, { style: { backgroundColor: '#e9e9e9' } }, _react2.default.createElement(_col2.default, { className: 'half-circle-up center' }, 'Go discussion'))), _react2.default.createElement(Element, { name: 'tutorial', className: 'element' }, _react2.default.createElement('div', { style: { padding: '10 50', backgroundColor: 'white', height: '80%' } }, _react2.default.createElement(_ConceptMapInformation2.default, null))), _react2.default.createElement(Element, { name: 'discussion', className: 'element' }, _react2.default.createElement(Link, { activeClass: 'active', onClick: this.scrollToTop, spy: true, smooth: true, offset: 50, duration: 500 }, _react2.default.createElement(_row2.default, { className: 'half-circle-down' }, _react2.default.createElement(_col2.default, { className: 'center' }, 'Review video'))), _react2.default.createElement('div', { style: { padding: '10 50', backgroundColor: '#e9e9e9', minHeight: '80%' } }, _react2.default.createElement(_ConceptMapping2.default, { courseURL: this.state.courseURL, courseID: this.state.courseID }))));
		}
	});
