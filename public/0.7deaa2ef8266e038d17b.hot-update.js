...
/***/ function(module, exports, __webpack_require__) {
	...
	var _style4 = __webpack_require__(371);
	...
	var Message = _react2.default.createClass({
		...
		render: function render() {
			var _ = this.props;
			if (_.who == _.me) return _react2.default.createElement('p', { className: 'right' }, ' ', _.message, ' ');else return _react2.default.createElement('p', { className: 'left' }, ' ', _.message, ' ');
		}
	});
	...
	var ChatRoom = _react2.default.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			this.fire.on('value', updateMessages);
		},
		...
		render: function render() {
			...
			var messages = this.state.messages.map(function (m, index) {
				return _react2.default.createElement(Message, { who: m.who, message: m.message, me: _this.state.user });
			});
			return _react2.default.createElement('div', null, _react2.default.createElement(_row2.default, null, _react2.default.createElement(_col2.default, { className: 'chat-container' }, messages)), _react2.default.createElement(_row2.default, null, _react2.default.createElement(_input2.default, {
				prefix: _react2.default.createElement(Icon, { type: 'message' }),
