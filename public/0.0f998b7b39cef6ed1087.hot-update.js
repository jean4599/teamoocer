	...
	var ConceptAggregation = _react2.default.createClass({
	  ...
	  showMark: function showMark(value) {
	    var result = this.state.concepts.filter(function (obj) {
	      console.log(parseFloat(obj.played).toFixed(2));return parseFloat(obj.played).toFixed(2) == value;
	    });
	  ...
	  render: function render() {
	    ...
	    })), _react2.default.createElement(_slider2.default, { tipFormatter: this.showMark, marks: this.state.marks, min: 0, max: 1, step: 0.01 }), _react2.default.createElement(_VideoPlayer2.default, { courseURL: this.state.courseURL, width: 640, height: 390, controls: false })));
	  }
	});
