...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConceptAggregation = _react2.default.createClass({
	  ...
	  handleLevelChange: function handleLevelChange(e) {
	    if (this.state.selectedLevel != e.target.id) {
	  ...
	  render: function render() {
	    ...
	    })), _react2.default.createElement(_col2.default, null, _react2.default.createElement(_card2.default, { id: 'l1', title: 'Level 1', style: { width: 300 }, onClick: this.handleLevelChange }, this.state.level1_concepts), _react2.default.createElement(_card2.default, { id: 'l2', title: 'Level 2', style: { width: 300 }, onClick: this.handleLevelChange }, this.state.level2_concepts), _react2.default.createElement(_card2.default, { id: 'l3', title: 'Level 3', style: { width: 300 }, onClick: this.handleLevelChange }, this.state.level3_concepts)));
	  }
	});
