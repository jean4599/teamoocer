...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConceptAggregation = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    })), _react2.default.createElement(_slider2.default, { value: this.state.sliderValue, onChange: function onChange() {
	        return _this.handleSliderChanged;
	      }, tipFormatter: this.showMark, marks: this.state.marks, min: 0, max: 1, step: 0.01 }), _react2.default.createElement(_VideoPlayer2.default, { playing: false, courseURL: this.state.courseURL, width: 640, height: 390, controls: false })));
	  }
	});
